namespace surfs_up_project.Models
{
    public static class ProductRepository //CRUD
 {
     ...
     {
         new Product {ProductId = 1, Name = "The Minilog", Length = 6, Width = 21, 
         Thickness= 2.75, Volume = 38.8, Type="Shortboard", Price= 565 },
         
         new Product {ProductId = 2, Name = "The Wide Glider", Length = 7.1, Width = 21.75, 
         Thickness= 2.75, Volume = 44.16, Type="Funboard", Price= 685 },
         
          new Product {ProductId = 3, Name = "The Golden Ratio", Length = 6.3, Width = 21.85, 
         Thickness= 2.9, Volume = 43.22, Type="Funboard", Price= 695 },

          new Product {ProductId = 4, Name = "Mahi Mahi", Length = 5.4, Width = 20.75, 
